...
public class QBRiskAssessment {
	WebDriver ldriver;

	public QBRiskAssessment(WebDriver rdriver){
	...
	public void saveRiskAssessmentAndNext() {
		btnSaveRiskAssNext.click();
	}
}
